...
[![GRC Gate](https://github.com/medivaultgmbh/medivault-azure/actions/workflows/grc-gate.yml/badge.svg)](https://github.com/medivaultgmbh/medivault-azure/actions/workflows/grc-gate.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![GDPR policies](https://img.shields.io/badge/GDPR%20policies-6-blueviolet)](policies/)
[![Auth: OIDC](https://img.shields.io/badge/auth-OIDC%20federated-success)](docs/RUNBOOK.md)
...
healthcare analytics platform on Azure, as designed in Parts 1 and 2.

> **Part of the MediVault project** —
> [docs](https://github.com/medivaultgmbh/medivault-docs) ·
> **infrastructure** (here) ·
> [identity governance](https://github.com/medivaultgmbh/medivault-entra-governance)

## Two configurations

| Path | Status | Cost |
|---|---|---|
| `terraform/` | Reference architecture — planned and policy-gated on every commit, **never applied** | ~€240/mo if deployed |
| `terraform/minimal/` | Governance plane — **deployed**, with documented exceptions | ~€0.55/mo |

The split is deliberate and explained in
[ADR-0006](https://github.com/medivaultgmbh/medivault-docs/blob/main/decisions/0006-reference-architecture-planned-not-applied.md):
the reference architecture's private endpoints make it unreachable from a
hosted CI runner, so it is verified but not run. Deviations in the deployed
subset are recorded in [`docs/EXCEPTIONS.md`](docs/EXCEPTIONS.md), never
suppressed.
